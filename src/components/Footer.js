...
function Footer() {
  return (
    <div className="bg-black flex px-12 py-8 justify-evenly text-slate-100 font-fsans mb-4 md:mb-0">
      <ul className="list-none">
        <li className="py-1 font-bold mb-4 text-gray-400">COMPANY</li>
        <li className="py-1 hover:cursor-pointer hover:font-semibold hover:text-white">
          About us
        </li>
        <li className="py-1 hover:cursor-pointer hover:font-semibold hover:text-white">
          Team
      ...
      <ul className="list-none mr-0">
        ...
        <li className="py-2 hover:scale-110 hover:ease-in-out hover:cursor-pointer duration-500">
          <img
            className="w-36"
