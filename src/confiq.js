export const img_cdn_path =
  "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/";

export const RESTURANT_API =
  "https://foodapi-1ngk.onrender.com/api/restaurants?lat=12.9715987&lng=77.5945627";
// "https://www.swiggy.com/dapi/restaurants/list/v5?lat=12.9715987&lng=77.5945627&offset=20&sortBy=RELEVANCE&pageType=SEE_ALL&page_type=DESKTOP_SEE_ALL_LISTING";

export const RESTURANT_MENU_API =
  "https://foodapi-1ngk.onrender.com/api/menu?lat=12.9715987&lng=77.5945627&restaurantId=";
...
export const faqs = [
  ...
  },
  {
    ...
    descriptions:
      "We will do our best to accommodate your request if the order is not placed to the restaurant (Customer service number:  080-67466XXX). Please note that we will have a right to charge a cancellation fee up to full order value to compensate our restaurant and delivery partners if your order has been confirmed.",
  },
  {
    id: 5,
